...
export default function ErrorPage() {
    return (
        <div className="flex flex-col items-center justify-center w-full lg:flex-row min-h-screen mx-auto px-4 py-12">
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                ...
                <a
                    href="#"
                    className="flex items-center space-x-2 bg-primary hover:bg-primary/70 text-gray-100 px-4 py-2 rounded transition duration-150"
                    title="Return Home"
                >
