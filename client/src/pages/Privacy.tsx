        ...
        <div className="">
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="relative mx-auto max-w-[50rem] pt-20 text-center pb-24">
                    ...
                    <p className="mt-4 text-base leading-7 text-slate-600">Last updated on January 30, 2024</p>
                </div>
            </div>
            <div className="relative px-4 sm:px-6 lg:px-8 mb-12">
                <div className="mx-auto max-w-[50rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600 text-slate-600 text-sm leading-6 text-justify">
                    <p>
                        This privacy policy ("Policy") describes how Task Management application. ("we", "us" or "our")
                        collects, protects and uses the personally identifiable information ("Personal Information") you
                        ("User", "you" or "your") may provide through the Task Management website (taskmanagement.localhost). The Policy also
                        describes the choices available to you regarding our use of your Personal Information and how
                        you can access and update this information. This Policy does not apply to the practices of
                    ...
                    <p>
                        We receive and store any information you knowingly provide to us when you use the website. Currently this is limited to your email address, which is required for you
                        to be able to login to the Website and access the task management features.
                    </p>
                    ...
                    <p>
                        ...
                        Currently this is limited to just your email address, as described above. You may also request
                        that we delete your email address, but this will prevent you from accessing the tasks you have created.
                    </p>
                    <p>
                        When you update information, we may maintain a copy of the unrevised information in our records.
                        Some information may remain in our private records after deletion of such information from your
                        account for a retention period. Once the retention period expires, Personal Information shall be
                        deleted. Therefore, the right to access, the right to erasure, your rights to access, add to,
                        and update your information cannot be enforced after the expiration of the retention period.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        password reminders, updates, etc; and operate our Website. Non-Personal Information collected is
                        used only to identify potential cases of abuse and establish statistical information regarding
                        Website usage. This statistical information is not otherwise aggregated in such a way that would
                        identify any particular user of the system.
                    </p>
                    <p>
                        We may process Personal Information related to you if one of the following applies: (i) You have
                        given their consent for one or more specific purposes. Note that under some legislations we may
                        ...
                        with you and/or for any pre-contractual obligations thereof; (ii) Processing is necessary for
                    ...
                    <p>
                        Depending on your location, data transfers may involve transferring and storing your information
                    ...
                    <p>
                        You may exercise certain rights regarding your information processed by us. In particular, you
                    ...
                    <p>
                        Where Personal Information is processed for a public interest, in the exercise of an official
                    ...
                    <p>
                        ...
                        are under the age of 13, please do not submit any Personal Information through our Website. We
                        encourage parents and legal guardians to monitor their children's Internet usage and to help
                        enforce this Policy by instructing their children never to provide Personal Information through
                        our Website without their permission. If you have reason to believe that a child under the age
                        of 13 has provided Personal Information to us through our Website, please contact us.
                    </p>
                    ...
                    <p>
                        ...
                        such as to comply with a subpoena, or similar legal process, and when we believe in good faith
                    ...
                    <p>
                        ...
                        revise the updated date at the bottom of this page. Continued use of the Website after any such
